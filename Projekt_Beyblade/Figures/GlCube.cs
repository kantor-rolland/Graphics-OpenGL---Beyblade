...
namespace Projekt_Beyblade.Figures
{
    internal class GlCube : GlObject
    {
        ...
        private GlCube(uint vao, uint vertices, uint colors, uint indeces, uint indexArrayLength, Vector3D<float> position, GL gl, uint texture = 0)
            : base(vao, vertices, colors, indeces, indexArrayLength, position, gl)
        {
            Texture = texture;
        }
        ...
        public static unsafe GlCube CreateCubeWithFaceColors(GL Gl, float[] face1Color, float[] face2Color, float[] face3Color, float[] face4Color, float[] face5Color, float[] face6Color)
        {
            ...
            return new GlCube(vao, vertices, colors, indices, indexArrayLength, position, Gl);
        }
        ...
        public static unsafe GlCube CreateSquare(GL Gl, float[] faceColor)
        {
            ...
            float[] vertexArray = new float[] {
                ...
                -200f, 0f, 200f, 0f, 1f, 0f, 0.0f, 1.0f,
                200f, 0f, 200f, 0f, 1f, 0f, 1.0f, 1.0f,
                200f, 0f, -200f, 0f, 1f, 0f, 1.0f, 0.0f,
                -200f, 0f, -200f, 0f, 1f, 0f, 0.0f, 0.0f
            };
        ...
        public static unsafe GlCube CreateSquareWithTexture(GL Gl, float[] faceColor, string textureResourceId)
        {
            uint vao = Gl.GenVertexArray();
            Gl.BindVertexArray(vao);
            ...
            float[] vertexArray = new float[] {
                ...
                -100f, 0f, 100f, 0f, 1f, 0f, 0.0f, 0.0f,
                100f, 0f, 100f, 0f, 1f, 0f, 1.0f, 0.0f,
                100f, 0f, -100f, 0f, 1f, 0f, 1.0f, 1.0f,
                -100f, 0f, -100f, 0f, 1f, 0f, 0.0f, 1.0f,
            };
            ...
            var textureImageResult = ReadTextureImage(textureResourceId);
            ...
            return new GlCube(vao, vertices, colors, indices, indexArrayLength, position, Gl, texture);
        }
        ...
        public static unsafe GlCube CreateInteriorCube(GL Gl, string textureResourceId)
        {
            ...
            var skyboxImageResult = ReadTextureImage(textureResourceId);
